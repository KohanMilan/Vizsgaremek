...
export function UserUpload({save,closeModal}) {
    let form = {
        username:  useState(""),
        password: useState(""),
        email: useState(""),
    ...
    return(
        <div className='userUploadContainer'>
            ...
            <div>        <FormControlLabel control={<Checkbox checked1={checked1} onChange={handle1Change} defaultChecked />} label="Enabled" /></div>
            ...
            <div>  <FormControlLabel control={<Checkbox checked2={checked2} onChange={handle2Change} defaultChecked />} label="Admin" /></div>
